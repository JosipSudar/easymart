    ...
    <main className="max-w-7xl mx-auto my-40 space-y-56">
      <div>
        ...
        <p className="text-3xl">
          ...
          online. Just like the world-renowned Amazon, we strive to provide an
          unparalleled shopping experience that combines convenience,
      ...
      <div className="flex gap-10">
        <div>
          ...
          <p className="text-3xl">
            easymart was founded with a simple yet powerful vision: to connect
            people with the products they love in the most efficient and
            enjoyable way possible. Inspired by the success of e-commerce giants
            like Amazon, we set out to create a platform that caters to the
            diverse needs of shoppers worldwide.
          </p>
        </div>
        <img
      ...
      <div>
        ...
        <ul className="text-2xl space-y-5 text-justify">
          <li className="list-inside list-disc">
            ...
            various categories, from electronics and fashion to home essentials
            and beyond, easymart offers something for everyone.
          </li>
          <li className="list-inside list-disc">
            Competitive Pricing: We work tirelessly to bring you the best deals
            and discounts on your favorite items, ensuring that you get the most
            value for your money.
          </li>
          <li className="list-inside list-disc">
            Fast and Reliable Shipping: Our streamlined logistics network
            ensures prompt delivery to your doorstep, wherever you are in the
            world.
          </li>
          <li className="list-inside list-disc">
      ...
      <div>
        ...
        <p className="text-3xl">
          ...
          e-commerce, we invite you to discover the convenience and excitement
          of shopping at easymart. Browse our extensive catalog, enjoy
          unbeatable deals, and experience the future of online shopping today.
        </p>
      </div>
      <p
