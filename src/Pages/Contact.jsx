    ...
    <main className="max-w-7xl mx-auto space-y-20 mt-40">
      <div>
        ...
        <p className="text-xl">
          ...
          our products, need assistance with an order, or simply want to share
          your thoughts with us, we're here to help. Get in touch with us using
      ...
      <div className="grid grid-cols-2 gap-10 items-center">
        <div className="space-y-4">
          ...
          <p className="text-lg">123 Main Street City, State, ZIP Country</p>
        </div>
        <div>
          <iframe
